  ...
  <section class="requirements">
    <div class="inner">
      ...
      <div class="requirements__content">
        <ul class="tab__menu">
          <li class="tab__menu-item js-tab-menu is-active" data-number="tab01">営業（正社員）</li>
          <li class="tab__menu-item js-tab-menu" data-number="tab02">製造（正社員）</li>
      ...
      <div class="occupation__content">
        <ul class="occupation__list">
          <li class="occupation__item">
            <a href="#" class="occupation__tag navy">正社員</a>
            <p class="occupation__post">募集職種タイトルダミー募集職種タイトルダミー募集職種</p>
            <p class="occupation__status red">募集中</p>
          </li>
          <li class="occupation__item">
            <a href="#" class="occupation__tag green">パート</a>
            <p class="occupation__post">募集職種タイトルダミー募集職種タイトルダミー募集職種</p>
            <p class="occupation__status">募集終了</p>
          </li>
        </ul>
        <div class="occupation__more">
          <div class="button">
            <a href="#" class="button__link button__link--occupation">募集職種一覧</a>
          </div>
        </div>
      </div>
    </div>
